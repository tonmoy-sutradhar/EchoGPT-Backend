...
export class SubscriptionsService {
  ...
  private async handleSubscriptionUpdated(stripeSub: Stripe.Subscription) {
    ...
    subscription.endsAt = new Date(item.current_period_end * 1000);
  ...
  private async handleSubscriptionDeleted(stripeSub: Stripe.Subscription) {
    ...
    // Fall back to the free plan so the user always has an active subscription
  ...
  // Exposed for Chat/Search modules to increment usage
